...
) -> tuple[collections.Counter, list[int]]:
...
def main():
    ...
    for dcolor in [3, 5]:
        ...
        ax.set_xticks(
            [e + 0.5 for e in range(len(labels))], labels, rotation=90, minor=True
        )
